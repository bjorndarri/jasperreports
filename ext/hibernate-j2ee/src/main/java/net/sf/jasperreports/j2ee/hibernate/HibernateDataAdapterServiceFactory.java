...
import net.sf.jasperreports.adapters.data.hibernate.HibernateDataAdapter;
import net.sf.jasperreports.adapters.data.hibernate.spring.SpringHibernateDataAdapter;
