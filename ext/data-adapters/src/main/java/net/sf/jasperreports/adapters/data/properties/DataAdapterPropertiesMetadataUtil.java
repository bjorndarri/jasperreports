 ...
 */
package net.sf.jasperreports.adapters.data.properties;
...
import net.sf.jasperreports.adapters.data.DataAdapterServiceUtil;
import net.sf.jasperreports.adapters.data.DataFileServiceFactory;
