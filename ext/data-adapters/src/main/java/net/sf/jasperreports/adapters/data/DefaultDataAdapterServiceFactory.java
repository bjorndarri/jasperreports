 ...
 */
package net.sf.jasperreports.adapters.data;

import java.util.Iterator;
import java.util.List;

import net.sf.jasperreports.adapters.data.bean.BeanDataAdapter;
import net.sf.jasperreports.adapters.data.bean.BeanDataAdapterService;
import net.sf.jasperreports.adapters.data.csv.CsvDataAdapter;
import net.sf.jasperreports.adapters.data.csv.CsvDataAdapterService;
import net.sf.jasperreports.adapters.data.ds.DataSourceDataAdapter;
import net.sf.jasperreports.adapters.data.ds.DataSourceDataAdapterService;
import net.sf.jasperreports.adapters.data.empty.EmptyDataAdapter;
import net.sf.jasperreports.adapters.data.empty.EmptyDataAdapterService;
import net.sf.jasperreports.adapters.data.jdbc.JdbcDataAdapter;
import net.sf.jasperreports.adapters.data.jdbc.JdbcDataAdapterContributorFactory;
import net.sf.jasperreports.adapters.data.jdbc.JdbcDataAdapterService;
import net.sf.jasperreports.adapters.data.jndi.JndiDataAdapter;
import net.sf.jasperreports.adapters.data.jndi.JndiDataAdapterService;
import net.sf.jasperreports.adapters.data.json.JsonDataAdapter;
import net.sf.jasperreports.adapters.data.json.JsonDataAdapterService;
import net.sf.jasperreports.adapters.data.provider.DataSourceProviderDataAdapter;
import net.sf.jasperreports.adapters.data.provider.DataSourceProviderDataAdapterService;
import net.sf.jasperreports.adapters.data.qe.QueryExecuterDataAdapter;
import net.sf.jasperreports.adapters.data.qe.QueryExecuterDataAdapterService;
import net.sf.jasperreports.adapters.data.random.RandomDataAdapter;
import net.sf.jasperreports.adapters.data.random.RandomDataAdapterService;
import net.sf.jasperreports.adapters.data.xml.XmlDataAdapter;
import net.sf.jasperreports.adapters.data.xml.XmlDataAdapterService;
