 ...
 */
package net.sf.jasperreports.adapters.data.json;
...
import net.sf.jasperreports.adapters.data.DataFile;
import net.sf.jasperreports.adapters.data.StandardRepositoryDataLocation;
import net.sf.jasperreports.adapters.data.AbstractDataAdapter;
import net.sf.jasperreports.adapters.data.RepositoryDataLocation;
...
public class JsonDataAdapterImpl extends AbstractDataAdapter implements
	...
	/**
	 * @deprecated replaced by {@link #setDataFile(DataFile)} and {@link StandardRepositoryDataLocation}
	 */
	@Override
	@Deprecated
